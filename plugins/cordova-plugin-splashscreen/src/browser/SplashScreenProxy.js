...
// Default parameter values including image size can be changed in `views.xml`
...
function readPreferencesFromCfg(cfg) {
    try {
        ...
        var msg = '[Browser][SplashScreen] Error occured on loading preferences from views.xml: ' + JSON.stringify(e);
        console.error(msg);
    }
}
...
/**
 * Tries to read views.xml and override default properties and then shows and hides splashcreen if it is enabled.
 */
